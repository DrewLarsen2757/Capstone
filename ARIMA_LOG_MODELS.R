...
f = fore.aruma.wge(COAST_df$LOG_COAST_LOAD,phi = COAST_Load_Model_First_Jan_Seven_Days$phi, 
                   ...
                   n.ahead = 151,limits = T, lastn = T)

##Unlog forecast
inverse_forecast <- expm1(f$f)

short_term_ase_unlogged <- mean((Actual_values$COAST_LOAD-f$f)^2)
short_term_ase_unlogged

#Append List
date_Range <- c(date_Range,"01/01/21-01/07/21")
Load_Zoad <-c(Load_Zoad,"COAST_LOAD")
ASE_Score <- c(ASE_Score,short_term_ase_unlogged)
...
short_term_ase_unlogged <- mean((Actual_values$EAST_LOAD-f$f)^2)
short_term_ase_unlogged
...
short_term_ase_unlogged <- mean((Actual_values$FAR_WEST_LOAD-f$f)^2)
short_term_ase_unlogged
...
short_term_ase_unlogged <- mean((Actual_values$NORTH_LOAD-f$f)^2)
short_term_ase_unlogged
...
short_term_ase_unlogged <- mean((Actual_values$NORTH_CENTRAL_LOAD-f$f)^2)
short_term_ase_unlogged
...
short_term_ase_unlogged <- mean((Actual_values$SOUTHERN_LOAD-f$f)^2)
short_term_ase_unlogged
...
short_term_ase_unlogged <- mean((Actual_values$SOUTH_CENTRAL_LOAD-f$f)^2)
short_term_ase_unlogged
...
short_term_ase_unlogged <- mean((Actual_values$WEST_LOAD-f$f)^2)
short_term_ase_unlogged
...
write.csv(new_df,"ARIMA_MODEL_Results.csv")
